    ...
    return (
        ...
        >
            ...
            <View style={styles.centerContainer}>
                <Text style={styles.text}>Vault MV-2ADK</Text>
                {route.params.isLocked === true ? <Text style={styles.lockedText}>LOCKED</Text> : <Text style={styles.unlockedText}>UNLOCKED</Text>}
            </View>
            <Image source={require('../../assets/images/vault.png')} style={{ alignSelf: 'center', marginTop: 30 }} />
            {route.params.isLocked ? <LockedContent /> : <UnlockedContent />}
        </View>
    );
}
